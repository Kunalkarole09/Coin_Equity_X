          ...
          MuiCard: {
            styleOverrides: {
              root: {
                ...
                border:
                  mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #EBEBEB',
                borderRadius: 8,
      ...
      <ThemeProvider theme={theme}>
        ...
        <Box
          sx={{
            ...
            background: mode === 'dark' ? '#0f1419' : '#F8F9FA'
          }}
        >
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <AppBar
        ...
        elevation={0}
        sx={{
          background: mode === 'dark' ? '#1a1f26' : '#FFFFFF',
          borderBottom:
            mode === 'dark' ? '1px solid rgba(255, 255, 255, 0.08)' : '1px solid #EBEBEB',
          boxShadow: 'none'
        }}
      ...
      <Container
        maxWidth="xl"
        sx={{ py: 4, px: { xs: 2, sm: 3, md: 4 }, minHeight: 'calc(100vh - 200px)' }}
      >
        <Suspense
          fallback={
            <Box
        ...
        >
          ...
          {tab === 2 && (
            <PageTransition>
              {marketMode === 'crypto' ? (
                <PortfolioPage
                  coins={Array.isArray(listings.data?.data) ? listings.data.data : []}
                />
              ) : (
                <StockPortfolioPage />
              )}
          ...
          {tab === 3 && (
            <PageTransition>
              {marketMode === 'crypto' ? (
                <NewsPage
                  items={Array.isArray(news.data?.data) ? news.data.data : []}
