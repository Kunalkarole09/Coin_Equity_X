          ...
          <Stack alignItems="center" spacing={3}>
            ...
            <Box sx={{ textAlign: 'center', width: '100%' }}>
              <Stack direction="row" alignItems="center" justifyContent="center" spacing={1} mb={1}>
                ...
                {user.emailVerified && <Verified sx={{ color: '#00D09C', fontSize: '1.2rem' }} />}
              </Stack>
          ...
          <Stack spacing={2}>
            <Paper
              ...
              sx={{
                p: 2,
                bgcolor: (theme) =>
                  theme.palette.mode === 'dark' ? 'rgba(0, 208, 156, 0.1)' : '#E8F5E9',
                borderRadius: 2
              }}
            >
              <Typography
            ...
            {profile && (
              <Stack direction="row" spacing={1} justifyContent="center" flexWrap="wrap">
                <Chip label="✓ Supabase Synced" color="success" size="small" variant="outlined" />
                <Chip
