...
describe('Utils', () => {
  ...
  describe('formatCurrency', () => {
    ...
    it('should format values < 1 with 10 decimals', () => {
      const result = formatCurrency(0.0000123456789, 'USD', mockFxRates);
    ...
    const mockCoins: Coin[] = [
      {
        ...
        symbol: 'BTC',
        quote: {
          USD: { price: 50000, market_cap: 1000000, volume_24h: 50000, percent_change_24h: 5 }
        }
      },
      {
        id: 2,
        ...
        symbol: 'ETH',
        quote: {
          USD: { price: 3000, market_cap: 500000, volume_24h: 30000, percent_change_24h: -2 }
        }
      },
      {
        id: 3,
