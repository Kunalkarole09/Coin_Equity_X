  ...
  const [messages, setMessages] = useState<ChatMessage[]>(() => [
    {
      id: uid(),
      role: 'assistant',
      text: 'Hi! Ask me anything about crypto/markets, the dashboard, or your portfolio.'
    }
  ]);
  ...
  async function onSend() {
    ...
    try {
      ...
      const assistantMsg: ChatMessage = {
        id: uid(),
        role: 'assistant',
        text: reply || 'Sorry, I could not generate a reply.'
      };
            ...
            <Stack direction="row" spacing={1} alignItems="center">
              ...
              <Box>
                ...
                <Typography
                  ...
                  sx={{ fontSize: '0.78rem', lineHeight: 1.1 }}
                >
                  Powered by Gemini
                </Typography>
              </Box>
