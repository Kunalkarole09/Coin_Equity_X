    ...
    <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <Stack spacing={1.5} sx={{ mt: 3, width: '100%' }}>
        {chartData.map((data, i) => {
          const percent = (
            (data.value / chartData.reduce((sum, d) => sum + d.value, 0)) *
            100
          ).toFixed(1);
          return (
            <Stack
                ...
                <Stack spacing={2}>
                  <Autocomplete
                    value={
                      selectedCoin
                        ? {
                            label: `${selectedCoin.name} (${selectedCoin.symbol})`,
                            coin: selectedCoin
                          }
                        : null
                    }
                ...
                <TableBody>
                  {entries.map((entry) => {
                    ...
                    const {
                      ...
                      pnlLocal,
                      pnlPct
                    } = computeEntry(entry, coin, currency, fxRates);
            ...
            <CardContent sx={{ p: 3 }}>
              ...
              {entries.length > 0 ? (
                ...
                <Box sx={{ textAlign: 'center', py: 6 }}>
                  ...
                  <Typography color="text.secondary">Add categories to see distribution</Typography>
                </Box>
              )}
            </CardContent>
          </Card>
