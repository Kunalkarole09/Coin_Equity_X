...
function computeEntry(
  ...
  const pnlLocal =
    valueLocal !== null && costBasisLocal !== null ? valueLocal - costBasisLocal : null;
                ...
                <Stack spacing={2}>
                  <Autocomplete
                    value={
                      selectedStock
                        ? {
                            label: `${selectedStock.description} (${selectedStock.symbol})`,
                            stock: selectedStock
                          }
                        : null
                    }
                    ...
                    isOptionEqualToValue={(option, value) =>
                      option.stock.symbol === value.stock.symbol
                    }
                  ...
                  <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                    ...
                    <TextField
                      ...
                      onChange={(e) =>
                        setForm((f) => ({ ...f, costCurrency: e.target.value as any }))
                      }
                      sx={{ minWidth: 120 }}
                    >
            ...
            <CardContent>
              ...
              <Table size="small">
                ...
                <TableBody>
                  {entries.map((entry) => {
                    const quote = quotes[entry.symbol];
                    const { buyPriceLocal, currentPriceLocal, valueLocal, pnlLocal, pnlPct } =
                      computeEntry(entry, quote, currency, fxRates);
                      ...
                      <TableRow key={entry.id} hover>
                        ...
                        <TableCell align="right">
                          ...
                          >
                            <Chip
                              size="small"
                              label={entry.costCurrency || '—'}
                              sx={{ height: 20 }}
                            />
                            <Typography variant="body2">
                              {formatCurrency(buyPriceLocal, currency, fxRates)}
                            </Typography>
                          </Stack>
                        </TableCell>
                        <TableCell align="right">
                          {formatCurrency(currentPriceLocal, currency, fxRates)}
                        </TableCell>
                        <TableCell align="right">
                          <Typography fontWeight={600}>
                            {formatCurrency(valueLocal, currency, fxRates)}
                          </Typography>
                        </TableCell>
                        <TableCell align="right">
                          {pnlLocal !== null ? (
            ...
            <CardContent sx={{ p: 3 }}>
              ...
              {entries.length > 0 ? (
                ...
                <Box sx={{ textAlign: 'center', py: 6 }}>
                  ...
                  <Typography color="text.secondary">Add holdings to see distribution</Typography>
                </Box>
              )}
            </CardContent>
          </Card>
